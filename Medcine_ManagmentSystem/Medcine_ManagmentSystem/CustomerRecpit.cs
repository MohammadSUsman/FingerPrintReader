...
namespace Medcine_ManagmentSystem
{
    ...
    {
        public static bool Insert(String VoucherID, String DateAndTime, double Amount, String CompanyID)
        {
        ...
        public static bool Update(string VoucherID, string DateAndTime, double Amount, string CompanyID)
        {
            SqlConnection con = new SqlConnection(Connection.connectionstring);
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = con;
        ...
        public static bool Delete(string VoucherID, string DateAndTime, double Amount, string CompanyID)
        {
            SqlConnection con = new SqlConnection(Connection.connectionstring);
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = con;
