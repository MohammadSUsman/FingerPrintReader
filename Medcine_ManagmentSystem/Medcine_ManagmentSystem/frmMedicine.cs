...
namespace Medcine_ManagmentSystem
{
    public partial class frmMedicine : Form
    {
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
           ...
           //{
            if (Medicine.Insert(cmbMedicine.Text, (txtSalt.Text), (Convert.ToInt32(txtStrength.Text)), (Convert.ToInt32(txtCompanyID.Text)), (txtMedicineType.Text)))
            {
                getTableDataMedicine();
           ...
           //}
            ...
            {
                if (MedicineDetails.Insert(cmbMedicineName.SelectedValue.ToString(), (Convert.ToInt32(txtBatchNo.Text)), (Convert.ToDateTime(dtpMenufacture.Text)), (Convert.ToDateTime(dtpExpiry.Text)), (Convert.ToDecimal(txtPrice))))
                {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            //if(Medicine.getTable(txtMedicineName.Text).Rows.Count == 0)
            //{
            if (Medicine.Update(cmbMedicine.SelectedValue.ToString(), (txtSalt.Text), (Convert.ToInt32(txtStrength.Text)), (Convert.ToInt32(txtCompanyID.Text)), (txtMedicineType.Text)))
            {
        ...
        {
            if (Medicine.Delete((cmbMedicine.SelectedValue.ToString()), (txtSalt.Text), (Convert.ToInt32(txtStrength.Text)), (Convert.ToInt32(txtCompanyID.Text)), (txtMedicineType.Text)))
            {
